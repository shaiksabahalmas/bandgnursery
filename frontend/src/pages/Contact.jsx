...
const handleSubmit = async (e) => {
  ...
  const googleFormURL =
    "https://docs.google.com/forms/d/e/1FAIpQLSdjD-dQMV1PL5W4lyro3P8OwYhOHWHw9mERLesrhmNvXioKVA/formResponse";

  const formData = new FormData();

  formData.append("entry.2039718328", form.name);
  formData.append("entry.1617572586", form.email);
  formData.append("entry.2110075821", form.phone);
  formData.append("entry.1273873327", form.message);
...
{submitted && (
  <motion.div
    ...
    exit={{ opacity: 0 }}
    className="bg-green-50 border border-green-200 text-green-700 px-6 py-4 rounded-xl text-center font-medium"
  >
